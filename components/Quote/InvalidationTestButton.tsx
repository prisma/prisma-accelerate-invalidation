    ...
    <>
      ...
      <div className="text-center mb-6">
        ...
        <div className="container mx-auto px-4 flex flex-col  items-center">
          ...
          <br />
          <p className="text-lg max-w-[680px] text-slate-600 dark:text-slate-400">
          ...
          <Collapsible
            ...
            className="mt-8 border-[#E2E8F0] border-2 bg-[#F7FAFC] rounded-md w-fit"
          >
            <CollapsibleTrigger>
              <p className="text-lg text-slate-500 p-2">
                Learn how the app works{" "}
                <span className="text-[#555555] inline-flex align-middle">
                  {!isOpen ? <FaChevronDown /> : <FaChevronUp />}{" "}
                </span>
              </p>
            </CollapsibleTrigger>
            <CollapsibleContent>
              <div className="flex flex-col justify-center items-center pb-4 pl-8 pr-8">
      ...
      <div className="flex items-center justify-center mb-6 space-x-3">
        <button
          ...
          disabled={isLoading}
          className="focus:outline-none text-white bg-[#5A67D8] hover:bg-[#4C51BF] focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-indigo-500 dark:hover:bg-indigo-600 dark:focus:ring-indigo-700 disabled:opacity-50"
        >
          <p className="text-xl">Start cache invalidation test</p>
        </button>
        {isLoading && (
      ...
      {finalResult && (
        <p className="p-8 text-[#16A394]  text-center text-xl font-extrabold">
          ✅ {finalResult}
        </p>
      )}
    </>
